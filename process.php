...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
     ...
     $check_duplicate_sql = "SELECT COUNT(*) FROM customers WHERE contract_number = '$contract_number'";
     ...
     if ($result->fetch_row()[0] > 0) {
         ...
         $sql = "INSERT INTO customers (contract_number, client_name, phone_number, activation_date, address, change_every, area, contract_notes, mop_18, price_mop_18, mop_36, price_mop_36, mit, price_mit, hd_1, price_hd_1, hd_2, price_hd_2, total_price) 
                 VALUES ('$contract_number', '$client_name', '$phone_number', '$activation_date', '$address', '$change_every', '$area', '$contract_notes', $mop_18, $price_mop_18, $mop_36, $price_mop_36, $mit, $price_mit, $hd_1, $price_hd_1, $hd_2, $price_hd_2, $total_price)";
