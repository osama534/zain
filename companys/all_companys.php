...
$sql = "SELECT COUNT(*) FROM company $whereClause";
...
$sql = "SELECT * FROM company $whereClause LIMIT $offset, $results_per_page";
...
<body>
    <div class="container mt-4">
        ...
        <div class="form-container">
            <form method="POST" action="companys/all_companys.php" class="form-inline mb-4">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    <?php while($row = $result->fetch_assoc()): ?>
                        <tr>
                            <td>
                                <a href="contract_details.php?id=<?php echo urlencode($row['id']); ?>" target="_blank">
                            ...
                            <td>
                                <a href="contract_details.php?id=<?php echo urlencode($row['id']); ?>" class="btn btn-info btn-sm" target="_blank">
                                View
                                </a>
                            </td>
                        </tr>
            ...
            <ul class="pagination justify-content-center">
                <?php for ($page = 1; $page <= $total_pages; $page++): ?>
                    <li class="page-item <?php if ($page == $current_page) echo 'active'; ?>">
                        <a class="page-link" href="<?php echo 'all_companys.php?page=' . $page . '&contract_number=' . urlencode($search_query); ?>">
                            <?php echo $page; ?>
                        </a>
                    </li>
                <?php endfor; ?>
