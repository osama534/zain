...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['cancel'])) {
        ...
        try {
            // Move to canceled_companys table
            $sql_cancel = "INSERT INTO canceled_companys (
                contract_number, company_name, phone_number, activation_date, address,
            ...
            // Delete from company
            $sql_delete = "DELETE FROM company WHERE id = $id";
            $conn->query($sql_delete);

            // Commit transaction
            $conn->commit();

            header('Location: all_companys.php?message=Contract cancelled');
            exit;
        } catch (Exception $e) {
        ...
        header('Location: all_companys.php?message=Contract updated');
        exit;
    }
}
?>
...
<body>
    <div class="container">
        ...
        <form method="POST" action="contract_details.php?id=<?php echo $id; ?>">
            <div class="form-row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control" id="company_name" name="company_name" value="<?php echo htmlspecialchars($contract['company_name']); ?>" required>
                </div>
                <div class="form-group col-md-4">
