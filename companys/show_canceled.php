...
$sql = "SELECT * FROM canceled_companys WHERE 1=1";
if ($contractNumber) {
    $sql .= " AND contract_number LIKE '%" . $conn->real_escape_string($contractNumber) . "%'";
}
if ($companyName) {
    $sql .= " AND company_name LIKE '%" . $conn->real_escape_string($companyName) . "%'";
}
if ($phoneNumber) {
...
<head>
    ...
    <title>All Canceled Companys</title>
...
<body>
    <div class="container">
        ...
        <div class="form-container">
            <form class="form-inline" method="GET" action="companys/cancel_results.php">
                ...
                <input type="text" name="company_name" class="form-control" placeholder="Company Name" value="<?php echo htmlspecialchars($companyName); ?>">
        ...
        <table class="table table-hover table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo htmlspecialchars($contract['canceled_date']); ?></td>
