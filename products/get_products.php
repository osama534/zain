...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card p-4">
                <h2 class="text-center">استلام المنتجات من المناديب</h2>
                <form action="save_get.php" method="POST">
                    <div class="form section">
                        <div class="form-row row">
                            <div class="col-md-6">
                                ...
                                $sql = "SELECT id, representative_name FROM representatives";
                    ...
                    <button type="submit" class="btn btn-primary btn-block"> حفظ منتجات الاستلام</button>
                </form>
            </div>
        </div>
    </div>
